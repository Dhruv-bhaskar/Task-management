    ...
    <nav className="flex justify-between items-center w-screen h-[5.1rem] rounded-md px-4 bg-black/5 mb-10 dark:bg-gray-400/70 box-border transition-colors duration-300">
      ...
      <div className="relative">
        <div className="flex items-center gap-4">
          <Link className="dark:text-white dark:bg-gray-400 text-gray-700 bg-gray-200 border-2 border-gray-400 rounded-2xl px-3 py-1.5 hover:bg-gray-600 hover:text-white transition-colors">Dashboard</Link>
          <img
          src="/user.png"
          alt="userlogo"
          onClick={handleclick}
